...
onMounted(() => {
      ...
      const levelsData = {
        ...
        level5: {
          ...
          transformers: [
            { x: 1350, y: 1400, height: 280, mode: PLAYER_MODE_FLAPPY },
            { x: 2670, y: 1240, height: 280 },
            { x: 4070, y: 840, height: 200, mode: PLAYER_MODE_FLAPPY },
        ...
        level6: {
          ...
          transformers: [
            { x: 800, y: 1990, width: 480, mode: PLAYER_MODE_FLAPPY },
            { x: 2120, y: 240, height: 280 },
            { x: 3440, y: 560, width: 320 },
            { x: 4240, y: 640, width: 320 },
            { x: 8770, y: 800, height: 240, mode: PLAYER_MODE_FLAPPY },
          ],
      ...
      function addDesignEvent(name, value = 1) {
      ...
      function getLevelTotalCoins(levelNum) {
      ...
      class PreloaderScene extends Phaser.Scene {
        ...
        preload() {
          ...
          this.load.audio('sfxCoin', 'audio/sfx-coin.mp3')
      ...
      class AudioScene extends Phaser.Scene {
        ...
        create() {
          ...
          if (!this.sound.get('music')) {
            ...
            const sfxCoin = this.sound.add('sfxCoin')
      ...
      class HUDScene extends Phaser.Scene {
        ...
        create() {
          ...
          // Pièces
          this.coinsCollected = (this.registry.get('coinsCollected') || []).reduce((acc, val) => acc + val, 0)
          this.add.circle(20, 20, 10, 0xffec27)
          this.coinsText = this.add.text(36, 10, `x${this.coinsCollected.toString().padStart(2, '0')}`, {
            fontSize: '24px',
            fill: '#ffffff',
          })
        ...
        handleLevelEnd({ currentLevel, startedFromCheckpoint }) {
          ...
          updateLevelInfo(currentLevel, {
            ...(this.registry.get('mode') === 'speedrun' && newTime < previousBestTime && { time: newTime }),
      ...
      class LevelsScene extends Phaser.Scene {
        ...
        create() {
          ...
          this.registry.set('coinsCollected', false)
          const unlockedLevels = getUnlockedLevels()
          ...
          for (let i = 0; i < NUM_LEVELS; i++) {
            ...
            if (coins > 0 && coins === levelTotalCoins) {
              this.add.circle(x, y + 24, 4, levelInfo.shinyCoin ? 0xffec27 : 0xffa300)
            }
          }
      ...
      class GameScene extends Phaser.Scene {
        ...
        create() {
          ...
          const coinsCollected = this.registry.get('coinsCollected') || []
        ...
        addCoins() {
          ...
          for (let i = 0; i < coinsPos.length; i++) {
            ...
            for (let j = 0; j < Math.max(numX, numY); j++) {
              ...
              this.coins.add(coin)
              coin.setData('collectedIndex', coinIndex - 1)
            }
          }
        }
        ...
        handleCoin(player, coin) {
          ...
          this.audioManager.playSfx('sfxCoin')
          this.coinsCollected[coin.getData('collectedIndex')] = 1
